...
metadata = {'protocolName': 'LDH for plate 2 - exp4', 'author': 'Francel',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # lysate destination:
    lysate_plate2 = [destination['A4'], destination['A5'], destination['A6'], destination['B4'], destination['B5'],
                     destination['B6'],
