...
metadata = {'protocolName': 'LDH for plate 2 - exp6', 'author': 'Francel',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # lysate destination:
    lysate_plate1 = [destination['A7'], destination['A8'], destination['A9'], destination['B7'], destination['B8'],
                     destination['B9'],
